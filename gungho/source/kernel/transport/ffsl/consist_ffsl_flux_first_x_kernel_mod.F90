...
!-----------------------------------------------------------------------------
!> @brief Calculates the first flux in x for consistent FFSL.
...
module consist_ffsl_flux_first_x_kernel_mod
  ...
  contains
    procedure, nopass :: consist_ffsl_flux_first_x_code
  end type

  !-------------------------------------------------------------------------------
  ! Contained functions/subroutines
  !-------------------------------------------------------------------------------
  public :: consist_ffsl_flux_first_x_code

contains

  !> @brief Compute the first fluxes in x for consistent FFSL.
  ...
  subroutine consist_ffsl_flux_first_x_code( nlayers,          &
                                             flux_high,        &
                                             flux_low,         &
                                             flux_int,         &
                                             field,            &
  ...
  end subroutine consist_ffsl_flux_first_x_code

end module consist_ffsl_flux_first_x_kernel_mod
