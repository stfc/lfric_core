...
!> @detail Extracts horizontal dof components from a 3D wind field
...
!! @param[inout] h_wind Real array, horizontal components of wind
...
subroutine extract_uv_code(nlayers,      &
  ...
  integer, dimension(ndf_w2h),  intent(in)             :: map_w2h
