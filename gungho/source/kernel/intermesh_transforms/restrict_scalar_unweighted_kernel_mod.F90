...
!> @brief The unweighted restriction operation for scalar fields.
!> @details Restrict a scalar field on a fine grid to a coarse grid field. No
!!          weighting is used for the averaging.
!!          This kernel only works for the lowest-order W3 and Wtheta spaces

module restrict_scalar_unweighted_kernel_mod
...
type, public, extends(kernel_type) :: restrict_scalar_unweighted_kernel_type
   private
...
end type restrict_scalar_unweighted_kernel_type

public :: restrict_scalar_unweighted_kernel_code

  ! Generic interface for real32 and real64 types
  interface restrict_scalar_unweighted_kernel_code
    module procedure  &
      restrict_scalar_unweighted_code_r_single, &
      restrict_scalar_unweighted_code_r_double
  end interface
...
contains
  ...
  ! R_SINGLE PRECISION
  ! ==================
  subroutine restrict_scalar_unweighted_code_r_single(              &
                                           nlayers,                 &
                                           cell_map,                &
  ...
  end subroutine restrict_scalar_unweighted_code_r_single
  ...
  end subroutine restrict_scalar_unweighted_code_r_double


end module restrict_scalar_unweighted_kernel_mod
