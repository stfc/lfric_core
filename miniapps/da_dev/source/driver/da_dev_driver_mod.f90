...
module da_dev_driver_mod
  ...
  private
  ! LFRic-API
  public initialise_lfric, finalise_lfric, step_lfric
...
contains
  ...
  !>
  subroutine initialise_model( mpi, model_data )
    ...
    call init_da( mpi%get_comm(), chi, panel_id, model_clock, get_calendar() )
