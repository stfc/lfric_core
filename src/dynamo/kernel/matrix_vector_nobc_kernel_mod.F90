...
module matrix_vector_nobc_kernel_mod
...
type, public, extends(kernel_type) :: matrix_vector_nobc_kernel_type
  private
...
contains
  procedure, nopass ::matrix_vector_nobc_code
end type
...
interface matrix_vector_nobc_kernel_type
   module procedure matrix_vector_nobc_kernel_constructor
end interface

!-------------------------------------------------------------------------------
! Contained functions/subroutines
!-------------------------------------------------------------------------------
public matrix_vector_nobc_code
contains

  type(matrix_vector_nobc_kernel_type) function matrix_vector_nobc_kernel_constructor() result(self)
  return
end function matrix_vector_nobc_kernel_constructor

!> @brief Computes lhs = matrix*x, same code as vanilla matrix_vector_kernel but
!!        renamed to avoid psyclone producing enforce_bc calls, see #678
...
subroutine matrix_vector_nobc_code(cell,        &
                              nlayers,     &
                              lhs, x,      & 
                              ncell_3d,    &
                              matrix,      &
...
end subroutine matrix_vector_nobc_code

end module matrix_vector_nobc_kernel_mod
