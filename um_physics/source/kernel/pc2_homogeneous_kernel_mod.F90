...
subroutine pc2_homogeneous_code( nlayers,                    &
    ...
    do k = 1, model_levels
      ...
      ! But all subsequent calculations need to be done on the current value
    ...
    do k = 1, model_levels
      ...
      theta_work(1,1,k) = t_work(1,1,k) / exner_wth(map_wth(1) + k)
...
end subroutine pc2_homogeneous_code

end module pc2_homogeneous_kernel_mod
